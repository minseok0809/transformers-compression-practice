...
class BertSelfAttention(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask=None, layer_num=-1):
...
class BertLayer(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask, layer_num=-1):
